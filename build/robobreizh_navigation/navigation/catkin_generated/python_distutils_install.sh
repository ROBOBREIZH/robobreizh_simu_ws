...
echo_and_run cd "/home/maelic/robobreizh_simu_ws/src/robobreizh_navigation/navigation"
...
echo_and_run /usr/bin/env \
    ...
    "/home/maelic/robobreizh_simu_ws/src/robobreizh_navigation/navigation/setup.py" \
     \
    build --build-base "/home/maelic/robobreizh_simu_ws/build/robobreizh_navigation/navigation" \
    install \
    --root="${DESTDIR-/}" \
