...
if("TRUE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /home/maelic/robobreizh_simu_ws/src/robobreizh_navigation/navigation)
  set(navigation_DEVEL_PREFIX /home/maelic/robobreizh_simu_ws/devel)
  ...
  set(navigation_INSTALL_PREFIX /home/maelic/robobreizh_simu_ws/install)
...
if(NOT "/home/maelic/robobreizh_simu_ws/devel/include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'maelic <maelic@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/maelic/robobreizh_simu_ws/src/robobreizh_navigation/navigation/${idir}'.  ${_report}")
    endif()
