...
echo_and_run cd "/home/maelic/robobreizh_simu_ws/src/gazebo_environment/pepper_robot/pepper_sensors_py"
...
echo_and_run /usr/bin/env \
    ...
    "/home/maelic/robobreizh_simu_ws/src/gazebo_environment/pepper_robot/pepper_sensors_py/setup.py" \
     \
    build --build-base "/home/maelic/robobreizh_simu_ws/build/gazebo_environment/pepper_robot/pepper_sensors_py" \
    install \
    --root="${DESTDIR-/}" \
