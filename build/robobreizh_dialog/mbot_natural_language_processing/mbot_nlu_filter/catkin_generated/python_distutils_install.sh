...
echo_and_run cd "/home/maelic/robobreizh_simu_ws/src/robobreizh_dialog/mbot_natural_language_processing/mbot_nlu_filter"
...
echo_and_run /usr/bin/env \
    ...
    "/home/maelic/robobreizh_simu_ws/src/robobreizh_dialog/mbot_natural_language_processing/mbot_nlu_filter/setup.py" \
     \
    build --build-base "/home/maelic/robobreizh_simu_ws/build/robobreizh_dialog/mbot_natural_language_processing/mbot_nlu_filter" \
    install \
    --root="${DESTDIR-/}" \
