...
echo_and_run cd "/home/maelic/robobreizh_simu_ws/src/pepper_robot/pepper_sensors_py"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/maelic/robobreizh_simu_ws/src/pepper_robot/pepper_sensors_py/setup.py" \
     \
    build --build-base "/home/maelic/robobreizh_simu_ws/build/pepper_robot/pepper_sensors_py" \
    install \
    --root="${DESTDIR-/}" \
