...
echo_and_run cd "/home/maelic/robobreizh_simu_ws/src/robobreizh_dialog/mbot_natural_language_processing/mbot_nlu"
...
echo_and_run /usr/bin/env \
    ...
    "/home/maelic/robobreizh_simu_ws/src/robobreizh_dialog/mbot_natural_language_processing/mbot_nlu/setup.py" \
     \
    build --build-base "/home/maelic/robobreizh_simu_ws/build/robobreizh_dialog/mbot_natural_language_processing/mbot_nlu" \
    install \
    --root="${DESTDIR-/}" \
